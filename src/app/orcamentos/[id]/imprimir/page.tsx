...
import { AcoesDocumento } from "./acoes";
...
/**
 * Versão limpa do orçamento. O PDF e o JPG saem daqui mesmo, no
 * navegador: a folha (#folha) é fotografada e vira arquivo. Os botões
 * ficam fora dela para não entrarem na foto.
 */
export default async function ImprimirOrcamento({
  ...
  return (
    <>
      <div
        id="folha"
        className="mx-auto max-w-[820px] bg-white p-10 text-[#2a2d27] print:p-0"
      >
        ...
        <header className="flex items-start justify-between border-b-4 border-[#8cc63e] pb-4">
          <div>
            {/* <img> puro de propósito: é esta marcação que o
      ...
      <div className="nao-imprimir mx-auto max-w-[820px] px-10 pb-10">
        <AcoesDocumento nomeArquivo={o.numero} />
      </div>
    </>
  );
}
